...
namespace PatenteN.Quiz.Application.Guids {
    ...
    public class SequentialGuidGenerator : IGuidGenerator {
        ...
        public SequentialGuidType? DefaultSequentialGuidType { get; }

        private static readonly RandomNumberGenerator RandomNumberGenerator = RandomNumberGenerator.Create();

        public SequentialGuidGenerator(SequentialGuidType? defaultSequentialGuidType = null) {
            DefaultSequentialGuidType = defaultSequentialGuidType;
        }

        public Guid Create() {
            return Create(DefaultSequentialGuidType ?? SequentialGuidType.SequentialAtEnd);
        }
